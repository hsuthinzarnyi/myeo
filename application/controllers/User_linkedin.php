...
class User_linkedin extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->data['consumer_key'] = $this->config->item('814fpz2slfmnfx');
        $this->data['consumer_secret'] = $this->config->item('J7vMovtWKGqm0Iph');
        $this->data['callback_url'] = site_url() . '/User_linkedin/linkedin_submit';
    }

    function index()
    {
        echo anchor('User_linkedin/linkedin', 'Sign in with Linkedin');
    }
    ...
    function linkedin_submit()
    {
        ...
        echo anchor('User_linkedin/post', 'Post to Linkedin');
    }
