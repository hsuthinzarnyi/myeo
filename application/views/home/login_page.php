...
<div class="row" class="pg_header"  style="background-color:#004167" style="position:fixed;top:0;">
<!-- <span class="label_tag"> -->
  ...
  <div  class="background" style="background-color:#06c3c3">
    <div style="padding-top:40px;">
      ...
      <h3 class="title-class-3" style="font-family:open-sans">Post a new opportunity for free   <a href="#">here</a></h3>
    </div>
    <div class="row">
      <div class="row justify-content-around margin-pad ">
        ...
        <div class=" container col-md-offset-2 col-md-4 sign-up-with-email"><!-- style="text-align: center;padding-left: 50px;" -->
          <!-- <center> -->
          <form role="form">
              <center><h5 class="title-class-2">Sign In With</h5></center>
              <div class="form-group">
                <label for="name">Name</label>
                <input type="text" class="form-control" name="name" style="background-color:transparent" placeholder="Enter email">
              </div>
              <div class="form-group">
                <label for="email">Email address</label>
                <input type="email" class="form-control" name="email" style="background-color:transparent" placeholder="Enter email">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" name="cfmassword" style="background-color:transparent" placeholder="Password">
              </div>
